...
import {EmulatorManager} from '../android/EmulatorManager.js';
import {
	CreateAVDArgs,
	LaunchAppArgs,
	StartEmulatorArgs,
				...
				try {
					switch (name) {
						...
						case 'start_emulator':
							...
							return this.wrapResponse(
								await this.emulatorManager.startEmulator(args),
							);
						case 'stop_emulator':
							return this.wrapResponse(
						...
						case 'fold_emulator':
							return this.wrapResponse(
								await this.emulatorManager.foldEmulator(
									this.getPortArg(args),
								),
							);
						case 'unfold_emulator':
							return this.wrapResponse(
								await this.emulatorManager.unfoldEmulator(
									this.getPortArg(args),
								),
							);
						...
						case 'create_avd':
							...
							return this.wrapResponse(
								await this.emulatorManager.createAVD(args),
							);
						case 'get_emulator_info':
							return this.wrapResponse(
								JSON.stringify(
									await this.emulatorManager.getEmulatorInfo(
										this.getPortArg(args),
									),
									null,
									2,
								...
								contents: [
									{
										uri,
										mimeType: 'application/json',
										text: await this.emulatorManager.listEmulators(),
									},
								],
							};
								...
								contents: [
									{
										uri,
										mimeType: 'application/json',
										text: await this.emulatorManager.listRunningEmulators(),
									},
								],
							};
						default:
